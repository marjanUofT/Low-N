...
class OneHotRegressionModel(object):
    ...
    def __init__(self, top_model_type):
        ...
        print("OneHot constructor: ")
        print("top_model: " + str(self.top_model_type))
        print("sparse_refit: " + str(self.sparse_refit))
        print("model: " + str(self.model))
        print("alpha: " + str(self.alpha_in_interior))
    ...
    def train(self, aa_seqs, qfunc): # Meets required interface
        ...
        print("MODEL TRAINING: " + str(self.top_model_type))
        warnings.filterwarnings('ignore')
