...
sfGFP_seq_annotation = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Marjan/Low N/analysis/A003_policy_optimization/sfgfp_residues_annotated_with_secondary_structure.csv')
...
gfp_contact_map = np.load("/content/drive/MyDrive/Colab Notebooks/Marjan/Low N/analysis/A003_policy_optimization/1GFL_contact_map.npy")
...
gfp_pssm = pd.read_csv("/content/drive/MyDrive/Colab Notebooks/Marjan/Low N/analysis/A003_policy_optimization/gfp_full_pssm.txt")
